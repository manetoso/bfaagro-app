...
import { usePackagingStore, FIELDS_TYPES } from '@/stores/usePackagingStore'
import { fetchData } from '@/services/packagingServices'
 ...
 * @returns
 */
export const usePackagingDatatable = ({ field }) => {
