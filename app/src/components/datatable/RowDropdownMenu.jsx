...
/**
 *
 * @param {{editOnClick: () => void, eliminateOnClick: () => void}} props editOnClick and eliminateOnClick
 * @returns RowDropdownMenu component for the Datatable
 */
export function RowDropdownMenu({ editOnClick, eliminateOnClick }) {
  return (
