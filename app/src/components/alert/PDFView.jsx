 ...
 */
export function PDFView({ isOpen, closeModal, title, children }) {
  return (
    <>
        ...
        <Dialog as='div' className='relative z-50' onClose={closeModal}>
          ...
          <div className='fixed inset-0 overflow-y-auto'>
            <div className='flex min-h-full items-end text-center'>
              ...
              >
                <Dialog.Panel className='h-[90vh] w-full transform overflow-hidden overflow-y-auto border-t-4 border-black bg-white py-6 text-left align-middle shadow-xl transition-all'>
